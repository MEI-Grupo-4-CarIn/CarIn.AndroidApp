...
class UserRouteFragment : Fragment() {
    ...
    private fun getRoute(): MutableList<InfoVehicleActivity.RouteInfo> {
        ...
        routes.add(InfoVehicleActivity.RouteInfo("Porto", "Luxemburgo", "12 Fevereiro", "INFINITY Vision Qe", "18H30m", "1700"))
        routes.add(InfoVehicleActivity.RouteInfo("Lisboa", "Luxemburgo", "13 Fevereiro", "INFINITY Vision Qe", "18H30m", "1700"))
        routes.add(InfoVehicleActivity.RouteInfo("Porto", "Luxemburgo", "12 Fevereiro", "INFINITY Vision Qe", "18H30m", "1700"))
        routes.add(InfoVehicleActivity.RouteInfo("Lisboa", "Luxemburgo", "13 Fevereiro", "INFINITY Vision Qe", "18H30m", "1700"))
        routes.add(InfoVehicleActivity.RouteInfo("Porto", "Luxemburgo", "12 Fevereiro", "INFINITY Vision Qe", "18H30m", "1700"))
        routes.add(InfoVehicleActivity.RouteInfo("Lisboa", "Luxemburgo", "13 Fevereiro", "INFINITY Vision Qe", "18H30m", "1700"))
